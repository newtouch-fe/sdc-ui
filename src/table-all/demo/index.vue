  ...
  data() {
      ...
      return {
           tableData: [{"name":"赵伟","gender":"男","birthday":'1963-7-9',"height":"183","email":"zhao@gmail.com","tel":"156*****1987","hobby":"钢琴、书法、唱歌","address":"上海市黄浦区金陵东路569号17楼"},
            ...
            columns:[
                        {field: 'name', title:'姓名', width: 280, titleAlign: 'center',columnAlign:'center', isFrozen: true},
                        {field: 'gender', title:'性别', width: 170, titleAlign: 'center',columnAlign:'center', isFrozen: true},
                        {field: 'tel', title: '手机号码', width: 200, titleAlign: 'center',columnAlign:'center', },
                        {field: 'birthday', title: '出生日期', width: 150, titleAlign: 'center',columnAlign:'center'},
                        {field: 'hobby', title: '爱好', width: 250, titleAlign: 'center',columnAlign:'center'},
                        {field: 'address', title: '地址', width: 350, titleAlign: 'center',columnAlign:'left'}
                    ]
      }
