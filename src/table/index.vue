                    ...
                    <div class="v-table-header-inner" style="display: block;">
                        <table class="v-table-htable" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <template v-if="frozenTitleCols.length > 0">
                                <tr v-for="row in frozenTitleCols" :key="row">
                                    <td v-for="col in row"
...
<script>
    ...
    import classesMixin from './v-table/src/classes-mixin.js'
    import scrollControlMixin from './v-table/src/scroll-control-mixin.js'
    import frozenColumnsMixin from './v-table/src/frozen-columns-mixin.js'
    import tableResizeMixin from './v-table/src/table-resize-mixin.js'
    import sortControlMixin from './v-table/src/sort-control-mixin.js'
    import tableEmptyMixin from './v-table/src/table-empty-mixin.js'
    import dragWidthMixin from './v-table/src/drag-width-mixin.js'
    import cellEditMixin from './v-table/src/cell-edit-mixin.js'
    import bodyCellMergeMixin from './v-table/src/body-cell-merge-mixin.js'
    import titleCellMergeMixin from './v-table/src/title-cell-merge-mixin.js'
    import checkboxSelectionMixin from './v-table/src/checkbox-selection-mixin.js'
    import tableFooterMixin from './v-table/src/table-footer-mixin.js'
    import scrollBarControlMixin from './v-table/src/scroll-bar-control-mixin.js'
    import tableRowMouseEventsMixin from './v-table/src/table-row-mouse-events-mixin'
    import tableFiltersMixin from './v-table/src/table-filters-mixin'

    import utils from './src/utils/utils.js'
    import deepClone from './src/utils/deepClone.js'

    import tableEmpty from './v-table/src/table-empty.vue'
    import loading from './v-table/src/loading.vue'
