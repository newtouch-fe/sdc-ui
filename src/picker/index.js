...
import { BORDER_UNSET_TOP_BOTTOM } from '../_utils/constant';
import { pickerProps, DEFAULT_ITEM_HEIGHT } from './shared';
import { unitToPx } from '../_utils/format/unit';
...
export default createComponent({
  ...
  methods: {
    ...
    genTitle() {
      ...
      if (this.title) {
        return <div class={['sdc-single-ellipsis', bem('title')]}>{this.title}</div>;
      }
    },
